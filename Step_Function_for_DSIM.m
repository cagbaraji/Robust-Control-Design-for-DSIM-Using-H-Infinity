% Code to Determine the Step Function for the Dual Stator Machine
s=tf('s');
...
G=tf(denun,nun)
% Applying step function to evaluate the performance behaviour of existing DSIM model in time domain
step(G)
